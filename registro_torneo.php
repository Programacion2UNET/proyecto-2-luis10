   ...
   <style type="text/css">
        ...
        <script src="jquery-3.2.1.min.js"></script>
         ...
         function imprimir(usuario,clave) {
            ...
            document.write(" <form action='registrar.php'  method='post' id='formulario'><table><tr><td><label for='torneo'>Torneo</label></td> <td><select  name='torneo' id='torneo'><option id='lista'></option></select> </td>      </tr>      <tr>         <td><label for='cant'>participantes</label></td>         <td><input type='text' name='cant' id='cant' placeholder='cantidad de participantes'></td>     </tr>     <tr>            <td> <label for='cate'>categoria :</label></td>           <td><select name='categoria'>              <option>principiante</option>              <option>aficiaonado</option>              <option>profesional</option>          </select></td>     <tr>                  <tr>              <td><label for='usuario' style='visibility:hidden'>Usuario:</label></td>                <td><input type='text' id='usuario' name='usuario' placeholder='Ingresa tu usuario'  value="+usuario+" style='visibility:hidden'></td>            </tr>           <tr>              <td><label for='clave' style='visibility:hidden'>Clave :</label></td>                <td><input type='text' id='clave' name='clave' placeholder='Ingresa tu clave'  value="+clave+" style='visibility:hidden'></td>            </tr>     <tr>       <td><input class='boton' type='submit' value='registrar'  /></td>     </tr>     </table>     </form>");   
